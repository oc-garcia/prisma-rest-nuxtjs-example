...
__export(src_exports, {
  ...
  callInspectorAction: () => callInspectorAction,
  callInspectorNodeAction: () => callInspectorNodeAction,
  ...
  onEditInspectorState: () => onEditInspectorState,
...
var getInspectorNodeActions = defineDevToolsAction("devtools:inspector-node-actions", (devtools4, payload) => {
  return devtools4.api.getInspectorNodeActions(payload);
});
var callInspectorNodeAction = defineDevToolsAction("devtools:call-inspector-node-action", (devtools4, inspectorId, actionIndex, nodeId) => {
  return devtools4.api.callInspectorNodeAction(inspectorId, actionIndex, nodeId);
});
var getInspectorActions = defineDevToolsAction("devtools:inspector-actions", (devtools4, payload) => {
  return devtools4.api.getInspectorActions(payload);
});
var callInspectorAction = defineDevToolsAction("devtools:call-inspector-action", (devtools4, inspectorId, actionIndex, nodeId) => {
  return devtools4.api.callInspectorAction(inspectorId, actionIndex, nodeId);
});
...
var onComponentUpdated = defineDevToolsListener("devtools:on-component-updated", (devtools4, callback) => {
  devtools4.api.on.componentUpdated(() => {
    callback();
  });
});
var onEditInspectorState = defineDevToolsListener("devtools:on-edit-inspector-state", (devtools4, callback) => {
  devtools4.api.on.editInspectorState(async (payload) => {
...
// ../../node_modules/.pnpm/vite-hot-client@0.2.3_vite@5.2.11_@types+node@20.12.12_sass@1.77.1_terser@5.26.0_/node_modules/vite-hot-client/dist/index.mjs
