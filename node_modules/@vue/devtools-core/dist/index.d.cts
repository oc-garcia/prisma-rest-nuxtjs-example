...
declare const getInspectorNodeActions: (...args: any[]) => Promise<{
    icon: string;
    tooltip: string;
}[] | undefined>;
declare const callInspectorNodeAction: (...args: any[]) => Promise<void | undefined>;
declare const getInspectorActions: (...args: any[]) => Promise<{
    icon: string;
    tooltip: string;
}[] | undefined>;
declare const callInspectorAction: (...args: any[]) => Promise<void | undefined>;
...
declare const onComponentUpdated: (listener: (payload: {
    inspectorId: string;
    state?: InspectorState[] | undefined;
    getters?: InspectorState[] | undefined;
}) => void) => () => void;
declare const onEditInspectorState: (listener: (payload: {
    inspectorId: string;
    state?: InspectorState[] | undefined;
    getters?: InspectorState[] | undefined;
}) => void) => () => void;
...
export { type AssetEntry, type AssetImporter, type AssetInfo, type AssetType, Bridge, type BridgeAdapterOptions, type BridgeInstanceType, type CodeSnippet, type DevToolsPluginOptions, type DevtoolsBridgeAppRecord, HandShakeClient, HandShakeEvents, HandShakeServer, type ImageMeta, type ModuleInfo, callInspectorAction, callInspectorNodeAction, callViteClientListener, callViteServerAction, cancelInspectComponentInspector, checkVueInspectorDetected, createDevToolsVuePlugin, defineDevToolsAction, defineDevToolsListener, defineViteClientListener, defineViteServerAction, editInspectorState, enableVueInspector, getComponentBoundingRect, getComponentRenderCode, getDevToolsClientUrl, getDevToolsState, getInspectorActions, getInspectorNodeActions, getInspectorState, getInspectorTree, getMatchedRoutes, getRouterInfo, getTimelineLayer, initAppSeparateWindow, initDevToolsSeparateWindow, initDevToolsSeparateWindowBridge, initViteClientHotContext, initViteServerContext, inspectComponentInspector, navigateAction, onAddTimelineEvent, onComponentUpdated, onCustomCommandsUpdated, onCustomTabsUpdated, onDevToolsStateUpdated, onEditInspectorState, onInspectorStateUpdated, onInspectorTreeUpdated, onRouterInfoUpdated, openInEditor, prepareInjection, scrollToComponent, setDevToolsClientUrl, setupAppBridge, setupDevToolsBridge, toggleApp, toggleComponentInspector, toggleHighPerfMode, unhighlightElement, updateInspectorTreeId, useDevToolsBridge, useDevToolsState };
